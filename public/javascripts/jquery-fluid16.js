...
Toggle : function(){
	...
	$.each(
		["grid", "paragraphs", "blockquote", "list-items", "section-menu", "tables", "forms", "login-forms", "search", "articles", "accordion", "productsearch", "productcatalog", "news", "main", "customer", "opinion", "basket"],
		function() {
