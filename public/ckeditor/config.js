...
CKEDITOR.editorConfig = function( config )
{
    ...
    config.filebrowserBrowseUrl = "/ckeditor_assets/attachments";

    // The location of an external file browser, that should be launched when "Browse Server" button is pressed in the Flash dialog.
    config.filebrowserFlashBrowseUrl = "/ckeditor_assets/attachments";

    // The location of a script that handles file uploads in the Flash dialog.
    config.filebrowserFlashUploadUrl = "/ckeditor_assets/attachments";
    ...
    config.filebrowserUploadUrl = "/ckeditor_assets/attachments_files";
    // onfig.filebrowserUploadUrl = "/ckeditor_assets/attachments";
