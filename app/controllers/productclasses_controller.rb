  ...
  def create
    ...
    respond_to do |format|
      if @productclass.save
        format.html { redirect_to(@productclass, :notice => 'Productclass was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @productclass.update_attributes(params[:productclass])
        format.html { redirect_to(@productclass, :notice => 'Productclass was successfully updated.') }
        format.xml  { head :ok }
      else
